...
public class BarcodeFactory {
	 ...
	 * @throws IOException
	 */
	private static BufferedImage scale(int height,int width, boolean hasFiller) throws IOException {
		double ratio = 0.0; // 缩放比例
		
		BufferedImage srcImage = ImageIO.read(BarcodeFactory.class.getClassLoader().getResourceAsStream("logo.png"));
