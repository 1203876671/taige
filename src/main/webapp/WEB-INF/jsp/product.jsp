...
<div class="application-body">
    <div class="type-page">
        ...
        <div class="title">
            <span>产品资料下载</span> <a href="download-list.html" class="more">more</a>
        </div>
        <div class="subTitle">
            <span>APPLICATION RECOMMENDATION</span>
        </div>
...
<script>
    $('.data-title li').click(function () {
        $('.data-title li').removeClass('download-active').eq($(this).index()).addClass('download-active');
        var num = $(this).index();
        var ulW = $('.data-content-box ul').width();
        $('.data-content-box').animate({
            left: -num * ulW + 'px'
        }, 500);
    })
</script>
