...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/admin/index/css/H-ui.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/admin/index/css/H-ui.admin.css"/>
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/admin/index/css/iconfont.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/index/css/icheck.css"/>
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/static/admin/index/css/skin/skin.css" id="skin"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/index/css/style.css"/>

    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/admin/index/js/jquery.min.js"></script>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/admin/index/js/H-ui.admin.js"></script>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="companymanage.html" data-title="公司管理" href="javascript:void(0)">公司管理</a></li>
                </ul>
                <ul>
                    <li><a _href="invitemanage.html" data-title="招聘信息管理" href="javascript:void(0)">招聘信息管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="newsbrand.html?type=1" data-title="公司新闻" href="javascript:void(0)">公司新闻</a></li>
                </ul>
                <ul>
                    <li><a _href="newsbrand.html?type=2" data-title="行业动态" href="javascript:void(0)">行业动态</a></li>
                </ul>
            </dd>
        </dl>
    </div>
