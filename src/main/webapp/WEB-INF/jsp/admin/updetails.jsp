...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data"
          action="${pageContext.request.contextPath}/admin/insertdetalis.html" method="post">
        <input name="applyid" hidden="hidden" value="${applyid}"/>
        <input name="id" hidden="hidden" value="${details.id}"/>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>产品名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${details.name}" placeholder="" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>活性成份：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${details.ingredients}" placeholder="" id="ingredients"
                       name="ingredients">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${details.likeproduct}" placeholder="" id="likeproduct"
                       name="likeproduct">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${details.use}" placeholder="" id="use"
                       name="use">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" class="input-text" value="${details.file}" placeholder="" id="file"
                       name="filename">
            </div>
        </div>
        <div class="row cl">
