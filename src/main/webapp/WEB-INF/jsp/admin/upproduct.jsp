...
<nav class="breadcrumb">
    <a><i class="Hui-iconfont">&#xe67f;</i> ； 产品类别管理</a>
    <span class="c-gray en">&gt;</span> 修改产品类别信息
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data"
          action="${pageContext.request.contextPath}/admin/insertproduct.html" method="post">
        <input name="id" hidden="hidden" value="${product.id}"/>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${product.introduction}" placeholder="" id="introduction"
                       name="introduction">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <c:if test="${product.sort != null && product.sort != ''}">
                    <input type="text" class="input-text" value="${product.sort}" placeholder="0" id="sort" name="sort">
                </c:if>
                <c:if test="${product.sort == null || product.sort == ''}">
