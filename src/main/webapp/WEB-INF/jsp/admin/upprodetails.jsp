...
<nav class="breadcrumb">
    <a><i class="Hui-iconfont">&#xe67f;</i> ； 应用产品管理</a>
    <span class="c-gray en">&gt;</span> 修改${details.applyname}应用产品信息
    <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
       href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<h3 style="text-align:center;">应用产品修改/添加</h3>
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data"
          action="${pageContext.request.contextPath}/admin/insertprodetalis.html" method="post">
        <input name="proid" hidden="hidden" value="${proid}"/>
        <input name="id" hidden="hidden" value="${prodetails.id}"/>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>产品名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prodetails.name}" placeholder="" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>活性成份：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prodetails.ingredients}" placeholder="" id="ingredients"
                       name="ingredients">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>同类产品：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prodetails.likeproduct}" placeholder="" id="likeproduct"
                       name="likeproduct">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>产品用途：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prodetails.uses}" placeholder="" id="uses"
                       name="uses">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>产品溶剂：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prodetails.solvent}" placeholder="" id="solvent"
                       name="solvent">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>适用体系：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prodetails.system}" placeholder="" id="system"
                       name="system">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red">*</span>产品外观：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prodetails.appearance}" placeholder="" id="appearance"
                       name="appearance">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1"><span class="c-red"></span>产品文件：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" class="input-text" name="filename" value="${prodetails.file}"/>
            </div>
        </div>
        <div class="row cl">
