...
<div class="news_banner"
     style="background: url(${pageContext.request.contextPath}/static/images/news_banner.jpg)  repeat-x center top; background-size:cover;">
    <h2>新闻资讯</h2>
    <span></span>
    ...
    <div class="news_center">
        ...
        <div class="news_list" style="display: block;">
            <c:forEach items="${pageInfo.list}" var="itme">
                <a href="news_content.html?id=${itme.id}" class="news_list_a">
                    <div class="news_list_img animated slideInLeft">
                        <img src="${itme.img}"/>
                    </div>
                    <div class="news_list_content animated slideInDown">
                        <h3>${itme.title}</h3>
                        <p>${itme.outline}</p>
                    </div>
                    <div class="news_list_data animated slideInRight">
                        <c:set var="val" value="${fn:substring(itme.date,5,10)}"/>
                        <p>${val}</p>
                        <img src="${pageContext.request.contextPath}/static/images/news_chakan.png"/>
                    </div>
                </a>
            </c:forEach>
