...
<head>
    ...
    <meta name="viewport"
          content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,usesr-scalable=no"/>
    <meta name="format-detection" content="telephone=no"/>
    <meta name="apple-mobile-web-app-capable" content="yes"/>
    <meta name="apple-mobile-web-app-status-bar-style" content="black"/>
    <meta name="viewport"
          content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0 usesr-scalable=no"
    />
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/download-list.css">
...
<div class="download">
    ...
    <div class="download-le download-list-le">
        <div class="dl-le-title">
            <h3>产品资料下载</h3>
            <p>PRODUCT INFORMATION DOWNLOAD</p>
        </div>
        <div class="dl-tab">
            <ul class="clearfix">
        ...
        <div class="dl-list-box" style="display:block">
            ...
            <c:forEach items="${listProduct}" var="listProduct">
                <div class="dl-list">
                    <a class="dl-list-con" href="parameter.html?id=${listProduct.id}">
                        <ul class="clearfix">
                            <li>${listProduct.name}</li>
                            <li>${listProduct.likeproduct}</li>
                            <li>${listProduct.ingredients}</li>
                            <li>${listProduct.uses}</li>
                        </ul>
                    </a>
                    <div class="dl-pdf">
                        <a href="#" class="file" download="${listProduct.file}">
                            <ul>
                                <li>
        ...
        <div class="dl-list-box">
            ...
            <c:forEach items="${listProduct}" var="listProduct">
                <div class="dl-list">
                    ...
                    <div class="dl-pdf">
                        <a href="#" download="${listProduct.file}">
                            <ul>
                                <li>
                                    <img src="${pageContext.request.contextPath}/static/images/icon_pdf.png" alt="">
                                </li>
        ...
        <div class="dl-list-box">
            ...
            <c:forEach items="${listProduct}" var="listProduct">
                <div class="dl-list">
                    ...
                    <div class="dl-pdf">
                        <a href="#" download="${listProduct.file}" class="file">
                            <ul>
                                <li>
                                    <img src="${pageContext.request.contextPath}/static/images/icon_pdf.png" alt="">
                                </li>
...
<script>
    ...
    $('.dl-tab li').click(function () {
        $('.dl-tab li').removeClass('download-active');
        $(this).addClass('download-active');
        $('.dl-list-box').css('display', 'none').eq($(this).index()).css('display', 'block');
    })
</script>
</body>
